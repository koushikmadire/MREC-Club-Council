  ...
  return (
    <div>
      ...
      <div className="mb-3 mt-3">
        <h1 className="text-xl font-bold">Clubs @ MREC</h1>
        <p className="font-medium mt-3 mb-3">
          The clubs of MREC conduct various captivating events throughout the
          ...
          Affinity Groups & 23 Clubs at MREC, divided into technical and
          cultural categories.
        </p>
        <p className="font-medium mt-3 mb-3">
      ...
      <div>
        <h1 className="text-xl font-bold">Clubs Council MREC</h1>
        <p className="font-medium mt-3 mb-3">
